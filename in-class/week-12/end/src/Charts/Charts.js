...
import ScatterplotD3Controlled from './ScatterplotD3Controlled.js';
import ScatterplotReactControlled from './ScatterplotReactControlled.js';
          ...
          <div className='row'>
            <div className='col-12'>
              {/* <ScatterplotD3Controlled margin={margin} 
                data={props.data.experience} colorScale={colorScale}/> */}
              <ScatterplotReactControlled margin={margin}
                data={props.data.experience} colorScale={colorScale}/>
            </div>
            <div className='col-12'>
              <BarChart margin={margin} data={props.data.experience} 
                colorScale={colorScale}/>
            </div>
          </div>
        </div>
      </div>
      <div className="source">Data source and original rankings chart: 
